...
我们期待一种操作，可以消去 $\mathbf{R}_{1, 2}$。

**注意到**令 $\mathbf{S} = \begin{bmatrix} \mathbf{I}_r & \mathbf{R}_{1, 2} \\ \mathbf{O} & \mathbf{I}_{n - r} \end{bmatrix}$ 是满足条件的，则令 $\tilde{\mathbf{P}} = \mathbf{S} \mathbf{P}$ 即可，故存在性得证。
