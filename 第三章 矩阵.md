...
- 由于初等行列变换不改变行列式，可得 $|\mathbf{P} \mathbf{A}| = |\mathbf{A}|, |\mathbf{B} \mathbf{Q}| = |\mathbf{B}|$。
- 由于初等行列变换的操作均**可逆**，可得 $\exists \tilde{\mathbf{P}}, \text{s.t. } \tilde{\mathbf{P}} \mathbf{P} = \mathbf{I}$ 且 $\tilde{\mathbf{P}}$ 也为初等变换阵、$\exists \tilde{\mathbf{Q}}, \text{s.t. } \mathbf{Q} \tilde{\mathbf{Q}} = \mathbf{I}$ 且 $\tilde{\mathbf{Q}}$ 也为初等变换阵。
- _注：严格的“矩阵的逆”将在后面讨论。_
- 因此 $|(\mathbf{P} \mathbf{A}) (\mathbf{B} \mathbf{Q})| = |\tilde{\mathbf{P}} ((\mathbf{P} \mathbf{A}) (\mathbf{B} \mathbf{Q}))| = |(\tilde{\mathbf{P}} ((\mathbf{P} \mathbf{A}) (\mathbf{B} \mathbf{Q}))) \tilde{\mathbf{Q}}| = |(\tilde{\mathbf{P}} \mathbf{P}) \mathbf{A} \mathbf{B} (\mathbf{Q} \tilde{\mathbf{Q}})| = |\mathbf{I} \mathbf{A} \mathbf{B} \mathbf{I}| = |\mathbf{A} \mathbf{B}|$。
- 综上，可知 $|\mathbf{A} \mathbf{B}| = |\mathbf{A}| |\mathbf{B}|$。