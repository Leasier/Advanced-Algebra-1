...
在仿射坐标系 $\{O; \mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3\}$ 下，考察坐标表示的向量的外积：
...
在 $V$ 上定义内积，使得 $(\mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3)$ 构成**单位正交基**。
...
在三维空间 $V$ 上，对于标架 $\mathbf{F}$ 导出的外积 $\times$，称仿射坐标系 $\{O; \mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3\}$ 为右手系，若 $(\mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3)$ 与 $\mathbf{F}$ 定向相同；称其为左手系，若 $(\mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3)$ 与 $\mathbf{F}$ 定向相反。

特别地，取标架 $\mathbf{F}$ 导出的内积 $\cdot$，对于**单位正交基** $\mathbf{i}, \mathbf{j}, \mathbf{k}$，称该坐标系为右手系，若 $\mathbf{i} \times \mathbf{j} = \mathbf{k}$；称其为左手系，若 $\mathbf{i} \times \mathbf{j} = -\mathbf{k}$。
...
在三维空间 $V$ 上，对于标架 $\mathbf{F}$ 导出的外积 $\times$ 和内积 $\cdot$，定义混合积为一个函数 $V \times V \times V \to \mathbb{R}$，记作 $(\mathbf{a}, \mathbf{b}, \mathbf{c})$，满足 $(\mathbf{a}, \mathbf{b}, \mathbf{c}) = (\mathbf{a} \times \mathbf{b}) \cdot \mathbf{c}$。
...
为证明 (2)，考察**右手系** $\{O; \mathbf{i}, \mathbf{j}, \mathbf{k}\}$ 下，坐标表示的向量的混合积：
...
- 故 $a_1 = \dfrac{(\mathbf{a}, \mathbf{e}_2, \mathbf{e}_3)}{(\mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3)}$，利用混合积的行列式形式展开，转置后即得上面的结果。
- $a_2, a_3$ 的计算是同理的。

#### 定义：复合积

在三维空间 $V$ 上，对于标架 $\mathbf{F}$ 导出的外积 $\times$，称 $(\mathbf{a} \times \mathbf{b}) \times \mathbf{c}$ 为复合积。
