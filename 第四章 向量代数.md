...
答案也可以写成行列式形式 $\begin{vmatrix} (\mathbf{a}, \mathbf{c}) & (\mathbf{b}, \mathbf{c}) \\ (\mathbf{a}, \mathbf{d}) & (\mathbf{b}, \mathbf{d}) \end{vmatrix}$。
...
&= \begin{vmatrix} (\boldsymbol{\beta} \times \boldsymbol{\gamma}, \mathbf{\boldsymbol{\alpha}}) & (\boldsymbol{\beta} \times \boldsymbol{\gamma}, \mathbf{\boldsymbol{\beta}}) \\ (\boldsymbol{\gamma} \times \boldsymbol{\alpha}, \mathbf{\boldsymbol{\alpha}}) & (\boldsymbol{\gamma} \times \boldsymbol{\alpha}, \mathbf{\boldsymbol{\beta}}) \end{vmatrix} \\
